...
function GrenadeModel:__init(x, y, xt, yt)
    ...
    self:addComponent(DrawableComponent(resources.images.grenade, 0, 0.12 * relation(), 0.12 * relation(), 100, 130))
    self:addComponent(IsGrenade())
    self:addComponent(ExplosionComponent(80 * relation(), 240 * relation()))
